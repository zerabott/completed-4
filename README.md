...
3. Bot pushed to GitHub repository
...
git init
git add .
git commit -m "Initial commit - Telegram Confession Bot"
git branch -M main
...
MINI_ADMIN_ID_1=mini_admin_id (optional)
USE_POSTGRESQL=false  (for free tier with SQLite)
...
- ✅ PostgreSQL available in free tier (optional)
...
Render provides free PostgreSQL - just add it from your dashboard!
